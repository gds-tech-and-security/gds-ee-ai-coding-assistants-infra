...
aws iam create-role \
    --role-name DeployPipeline-GithubActions-sandbox-plan \
    --assume-role-policy-document file://./assume-role.json

aws iam put-role-policy \
    --role-name DeployPipeline-GithubActions-sandbox-plan \
    --policy-name DeployPipeline-GithubActions-sandbox-plan \
    --policy-document file://./permissions-policy.json

aws iam create-role \
    --role-name DeployPipeline-GithubActions-sandbox-apply \
    --assume-role-policy-document file://./assume-role.json

aws iam put-role-policy \
    --role-name DeployPipeline-GithubActions-sandbox-apply \
    --policy-name DeployPipeline-GithubActions-sandbox-apply \
    --policy-document file://./permissions-policy.json
